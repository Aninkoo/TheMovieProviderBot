...
• /restart - <code>ʀᴇꜱᴛᴀʀᴛ ᴛʜᴇ ʙᴏᴛ.</code>"""
    ...
    SHORTLINK_INFO = """<b>
 ❗<u>NEED A BOT LIKE THIS?</u>❗

Yᴏᴜ ᴄᴀɴ ᴜsᴇ ᴛʜɪs ᴛʏᴘᴇ ᴏғ ʙᴏᴛ ᴛᴏ ᴘʀᴏᴠɪᴅᴇ Mᴏᴠɪᴇs ᴏʀ ᴀɴʏ Mᴇᴅɪᴀ ᴏʀ ᴀɴʏ Fɪʟᴇs ɪɴ ʏᴏᴜʀ GROUP.

★ ɴᴏᴡ ʏᴏᴜ ᴄᴀɴ ꜱᴛᴀʀᴛ ᴇᴀʀɴɪɴɢ 💸 ᴍᴏɴᴇʏ ᴛᴏᴅᴀʏ ᴡɪᴛʜ ᴏᴜʀ ꜱɪᴍᴘʟᴇ ᴀɴᴅ ᴇᴀꜱʏ-ᴛᴏ-ᴜꜱᴇ ʙᴏᴛ!

• BY ᴄᴏɴɴᴇᴄᴛᴛɪɴɢ ꜱʜᴏʀᴛʟɪɴᴋ ᴡᴇʙꜱɪᴛᴇ ᴡɪᴛʜ ᴛʜɪs ʙᴏᴛ.
• BY ᴜsɪɴɢ TOKEN ᴛᴏ ғᴏʀᴄᴇ ᴛʜᴇ ᴜsᴇʀs ᴛᴏ ᴡᴀᴛᴄʜ/ᴠɪᴇᴡ ADS ᴏɴ ʏᴏᴜʀ ᴡᴇʙsɪᴛᴇ ᴛʜʀᴏᴜɢʜ Tᴇʟᴇɢʀᴀᴍ WᴇʙAᴘᴘ.

★ THE BOT SETUP AND DEPLOYMENT ★

• Sᴇᴛᴛɪɴɢ ᴜᴘ ᴛʜᴇɪs BOT ᴡɪʟʟ ᴄᴏsᴛ ʏᴏᴜ:
   1. $20 [ɪғ ʏᴏᴜ ʜᴀᴠᴇ Cʀᴇᴅɪᴛ Cᴀʀᴅ ᴛᴏ ʟɪɴᴋ ᴡɪᴛʜ ᴛʜᴇ Hᴏsᴛɪɴɢ ᴘʀᴏᴠɪᴅᴇʀ]
   2. $30 [ɪғ ʏᴏᴜ ᴡᴀɴᴛ ᴜs ᴛᴏ ᴜsᴇ ᴏᴜʀ Cʀᴇᴅɪᴛ Cᴀʀᴅ]

★ ᴅᴏɴ'ᴛ ᴡᴀɪᴛ ᴀɴʏ ʟᴏɴɢᴇʀ ᴛᴏ ꜱᴛᴀʀᴛ ᴇᴀʀɴɪɴɢ ᴍᴏɴᴇʏ ꜰʀᴏᴍ ʏᴏᴜʀ ᴛᴇʟᴇɢʀᴀᴍ ɢʀᴏᴜᴘ. Gᴇᴛ ᴛʜɪs Bᴏᴛ ᴛᴏᴅᴀʏ ᴀɴᴅ ꜱᴛᴀʀᴛ ᴍᴀᴋɪɴɢ ᴍᴏɴᴇʏ 💰!

Contact 👉 <a href="https://t.me/Mr_John_NigMore">PaxMOVIES ADMIN</a> 👈 for more!</b>
 </b>
"""
